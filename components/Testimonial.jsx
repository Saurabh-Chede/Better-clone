...
function Testimonial() {
  const testimonials = [
    {
      name: "Paul",
      videoUrl: "https://www.youtube.com/embed/pKy7cNtaJ0c",
      quote: "Paul's experience was amazing!",
    },
    {
      name: "Amanda",
      videoUrl: "https://www.youtube.com/embed/tF60HQo3vhU",
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="px-[24px]">
              <h2 className="text-[48px] lg:text-[88px] tracking-tight leading-tight lg:leading-[88px] font-bold text-gray-900 mb-6">
                Find out why
                we're better.
              </h2>
